...
| 2 | ☐ | SPEC-0016 — observability baseline | R2 | sonnet | 20/07/2026 05:48:16 | — | Ships only the observability mechanism (MDC propagation, structured logs) — no money or invariant surface touched (design-hardening option: see *Model allocation notes*); depends on SPEC-0018 |
