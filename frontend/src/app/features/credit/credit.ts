...
/**
 * Placeholder for the Credit feature.
 *
...
@Component({
  ...
  template: `
    <section data-testid="feature-credit" class="rounded-lg border border-dashed border-slate-300 bg-white p-8">
