...
/**
 * Placeholder for the Card feature.
 *
...
@Component({
  ...
  template: `
    <section data-testid="feature-card" class="rounded-lg border border-dashed border-slate-300 bg-white p-8">
