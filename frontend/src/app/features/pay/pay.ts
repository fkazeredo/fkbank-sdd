...
/**
 * Placeholder for the Pay feature.
 *
...
@Component({
  ...
  template: `
    <section data-testid="feature-pay" class="rounded-lg border border-dashed border-slate-300 bg-white p-8">
